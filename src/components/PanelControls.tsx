...
export default function PanelControls() {
  ...
  return <MobileFold simpleOnly title="Panel settings" persistKey="panel-controls"><div className="panel-controls flex justify-end flex-wrap gap-3 text-xs text-[var(--muted)] mb-3" aria-label="Page panels">
