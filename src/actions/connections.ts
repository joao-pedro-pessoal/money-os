      ...
      await db
        ...
        .values(
          state.activity.map((a) => ({
            ...
            brokerPositionId: a.brokerPositionId ?? null,
            brokerOpenedAt: a.brokerOpenedAt ? new Date(a.brokerOpenedAt) : null,
            brokerPositionSummary: a.brokerPositionSummary ?? false,
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...
            brokerPositionId: sql`excluded.broker_position_id`,
            brokerOpenedAt: sql`excluded.broker_opened_at`,
            brokerPositionSummary: sql`excluded.broker_position_summary`,
          },
        });
    }
