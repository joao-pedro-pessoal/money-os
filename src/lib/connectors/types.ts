...
export interface InvestmentActivityRow {
  ...
  externalId: string;
  /** A position lifecycle ID, never an order/fill ID or a reusable side slot. */
  brokerPositionId?: string | null;
  /** Creation time stated on a broker's position summary. */
  brokerOpenedAt?: string | null;
  /** This event summarises a closed position rather than an individual fill. */
  brokerPositionSummary?: boolean;
