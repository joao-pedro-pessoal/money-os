                  ...
                  <Fragment key={g.coin}>
                    ...
                    <tr>
                      <td className="font-medium">
                        <Link href={`/investments/asset/${encodeURIComponent(g.coin)}?type=${encodeURIComponent(g.parts[0]?.assetType ?? "")}`} className="hover:underline">{g.coin}</Link>
                        {g.parts.length > 1 && (
              ...
              <div className="table-scroll" role="region" aria-label="Scrollable data table" tabIndex={0}><table className="data-table whitespace-nowrap">
                ...
                <tbody>
                  {positions.map((p) => (
                    <tr key={p.id}>
                      <td className="font-medium">
                        <Link href={`/investments/asset/${encodeURIComponent(p.coin)}?type=${encodeURIComponent(p.assetType ?? "")}`} className="hover:underline">{p.coin}</Link>
                      </td>
                      <td className="whitespace-normal">
                        <PositionTagsForm
                          action={setPositionTags}
