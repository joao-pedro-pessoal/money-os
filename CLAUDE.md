...
`mobile/` is a separate native React Native/Expo application with encrypted local
storage and direct broker reads. Its storage layer is independent of the web
server; see `mobile/AGENTS.md` and `mobile/README.md`. Shared financial rules below
still apply. Do not import the web database/actions into the mobile bundle.
