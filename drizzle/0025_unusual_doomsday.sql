...
ALTER TABLE "investment_activities" ADD CONSTRAINT "investment_activities_import_id_imports_id_fk" FOREIGN KEY ("import_id") REFERENCES "public"."imports"("id") ON DELETE cascade ON UPDATE no action;