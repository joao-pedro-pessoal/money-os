...
| F08 | Widgets e ações em notificações | Reutilizar o registo rápido existente; garantir uma única gravação, moeda correta e tratamento de falhas. Depende da integração nativa. |
